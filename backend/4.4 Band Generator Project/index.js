...
app.post("/submit", (req, res) => {
  ...
  let RandonOne=adj[Math.floor(Math.random()*adj.length)];
  
  let RandonTwo=noun[Math.floor(Math.random()*noun.length)];
  res.render("index.ejs",{adjective : RandonOne,noun: RandonTwo});
});
